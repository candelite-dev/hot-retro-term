...
#if defined(Q_OS_WIN) && !defined(HAVE_UTF8PROC)
namespace {
struct interval {
    int first;
    int last;
...
// Markus Kuhn's mk_wcwidth() implementation, 2007-05-26 (Unicode 5.0).
// Permission to use, copy, modify, and distribute this software for any
// purpose and without fee is granted by the author.
int bisearch(wchar_t ucs, const interval* table, int max)
{
    int min = 0;
...
int mk_wcwidth(wchar_t ucs)
{
    ...
    if (bisearch(ucs, combining,
                 static_cast<int>(sizeof(combining) / sizeof(interval)) - 1))
        return 0;
